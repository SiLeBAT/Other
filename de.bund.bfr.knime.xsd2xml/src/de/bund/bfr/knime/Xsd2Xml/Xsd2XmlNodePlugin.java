 ...
 * @author 
 */
public class Xsd2XmlNodePlugin extends Plugin {
    // The shared instance.
    private static Xsd2XmlNodePlugin plugin;

    /**
     * The constructor.
     */
    public Xsd2XmlNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static Xsd2XmlNodePlugin getDefault() {
        return plugin;
    }
