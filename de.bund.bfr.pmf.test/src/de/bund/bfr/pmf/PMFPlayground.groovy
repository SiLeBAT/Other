...
class PMFPlayground {
	...
	PMFPlayground() {
		...
		new PMFWriter().write(new PMFDocument(dataSets: ['concentrations.xml': dataset], models: ['salModel.xml': model]), new File("test.zip"))
	}
	
	NuMLDocument createPMFNuml() {
