 ...
 */
public class MagicTableSamplingNodePlugin extends Plugin {
    // The shared instance.
    private static MagicTableSamplingNodePlugin plugin;

    /**
     * The constructor.
     */
    public MagicTableSamplingNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MagicTableSamplingNodePlugin getDefault() {
        return plugin;
    }
