 ...
 * @author BfR
 */
public class ExportWorkflowNodePlugin extends Plugin {
    // The shared instance.
    private static ExportWorkflowNodePlugin plugin;

    /**
     * The constructor.
     */
    public ExportWorkflowNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ExportWorkflowNodePlugin getDefault() {
        return plugin;
    }
