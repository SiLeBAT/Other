...
public class MyTab21NodeDialog extends DefaultNodeSettingsPane {
	...
	private final DialogComponentNumberEdit jahrDialog, kriterienJahrDialog, esblDialog, carbaDialog, enteroDialog;
    ...
    private final SettingsModelInteger carba = new SettingsModelInteger(MyTab21NodeModel.CARBA, 0);
    ...
    protected MyTab21NodeDialog() {
    	...
    	carbaDialog = new DialogComponentNumberEdit(carba, MyTab21NodeModel.CARBA);
    	...
    	addDialogComponent(carbaDialog);
