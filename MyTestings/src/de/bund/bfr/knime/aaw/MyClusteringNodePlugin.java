 ...
 * @author aaw
 */
public class MyClusteringNodePlugin extends Plugin {
    // The shared instance.
    private static MyClusteringNodePlugin plugin;

    /**
     * The constructor.
     */
    public MyClusteringNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MyClusteringNodePlugin getDefault() {
        return plugin;
    }
