...
public class ModelsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModelsSwitch<Adapter> modelSwitch = new ModelsSwitch<Adapter>() {
		...
		@Override
		public Adapter caseFormulaElement(FormulaElement object) {
			return createFormulaElementAdapter();
		}
		...
		@Override
		public Adapter caseStringToDoubleMapEntry(
				Map.Entry<String, Double> object) {
			return createStringToDoubleMapEntryAdapter();
		}

		@Override
		public Adapter caseStringToVariableRangeMapEntry(
				Map.Entry<String, VariableRange> object) {
			return createStringToVariableRangeMapEntryAdapter();
		}

		@Override
		public Adapter caseStringToParameterValueMapEntry(
	 ...
	 * <em>Model Formula</em>}'. <!-- begin-user-doc --> This default
	 ...
	 * <em>Formula Element</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @generated
	 */
	public Adapter createFormulaElementAdapter() {
		return null;
	}
	 ...
	 * <em>Variable Range</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Parameter Value</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Primary Model</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Secondary Model</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Tertiary Model</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Primary Model Formula</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Secondary Model Formula</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Tertiary Model Formula</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
