 ...
 * $Id$
 */
package de.bund.bfr.knime.pmm.core.common.util;
...
public class CommonSwitch<T> extends Switch<T> {
	 ...
	 * <em>Quantity Type</em>'. <!-- begin-user-doc --> This implementation
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Unit</em>'. <!-- begin-user-doc --> This implementation returns null;
