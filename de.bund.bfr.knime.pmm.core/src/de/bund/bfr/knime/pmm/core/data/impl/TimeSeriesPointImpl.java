 ...
 * <ul>
 * <li>{@link de.bund.bfr.knime.pmm.core.data.impl.TimeSeriesPointImpl#getTime
 * <em>Time</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.data.impl.TimeSeriesPointImpl#getConcentration
...
public class TimeSeriesPointImpl extends EObjectImpl implements TimeSeriesPoint {
	 ...
	 * @ordered
	 */
	protected static final double TIME_EDEFAULT = Double.NaN;
	...
	/**
	 * The default value of the '{@link #getConcentration()
	 ...
	 * @ordered
	 */
	protected static final double CONCENTRATION_EDEFAULT = Double.NaN;

	/**
	 * The cached value of the '{@link #getConcentration()
	 * <em>Concentration</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getConcentration()
	...
	public void setTime(double newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DataPackage.TIME_SERIES_POINT__TIME, oldTime, time));
	}
	...
	public void setConcentration(double newConcentration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DataPackage.TIME_SERIES_POINT__CONCENTRATION,
