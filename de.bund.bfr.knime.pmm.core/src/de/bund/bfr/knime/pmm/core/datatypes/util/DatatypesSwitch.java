/**
 */
package de.bund.bfr.knime.pmm.core.datatypes.util;
...
public class DatatypesSwitch<T> extends Switch<T> {
	 ...
	 * <em>EPair</em>'. <!-- begin-user-doc --> This implementation returns
	 ...
	 * @generated
	 */
	public T caseEPair(EPair object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>EString</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
