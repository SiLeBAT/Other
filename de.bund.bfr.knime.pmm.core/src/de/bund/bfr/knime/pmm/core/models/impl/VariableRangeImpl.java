 ...
 * <ul>
 * <li>{@link de.bund.bfr.knime.pmm.core.models.impl.VariableRangeImpl#getMin
 * <em>Min</em>}</li>
 * <li>{@link de.bund.bfr.knime.pmm.core.models.impl.VariableRangeImpl#getMax
 * <em>Max</em>}</li>
 * </ul>
 * </p>
 * 
...
public class VariableRangeImpl extends EObjectImpl implements VariableRange {
	...
	public void setMin(Double newMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.VARIABLE_RANGE__MIN, oldMin, min));
	}
	...
	public void setMax(Double newMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.VARIABLE_RANGE__MAX, oldMax, max));
	}
