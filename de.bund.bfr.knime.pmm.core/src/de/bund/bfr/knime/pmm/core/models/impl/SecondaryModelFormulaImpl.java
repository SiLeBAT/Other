 ...
 * <ul>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.SecondaryModelFormulaImpl#getId
 * <em>Id</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.SecondaryModelFormulaImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.SecondaryModelFormulaImpl#getFormula
 * <em>Formula</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.SecondaryModelFormulaImpl#getDepVar
 * <em>Dep Var</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.SecondaryModelFormulaImpl#getParams
 * <em>Params</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.SecondaryModelFormulaImpl#getIndepVars
 * <em>Indep Vars</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class SecondaryModelFormulaImpl extends EObjectImpl implements
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.SECONDARY_MODEL_FORMULA__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.SECONDARY_MODEL_FORMULA__NAME, oldName, name));
	}
	...
	public void setFormula(String newFormula) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.SECONDARY_MODEL_FORMULA__FORMULA, oldFormula,
					formula));
	}
	...
	public NotificationChain basicSetDepVar(Variable newDepVar,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ModelsPackage.SECONDARY_MODEL_FORMULA__DEP_VAR, oldDepVar,
					newDepVar);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDepVar(Variable newDepVar) {
		if (newDepVar != depVar) {
				...
				msgs = ((InternalEObject) depVar)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- ModelsPackage.SECONDARY_MODEL_FORMULA__DEP_VAR,
								null, msgs);
			if (newDepVar != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.SECONDARY_MODEL_FORMULA__DEP_VAR, newDepVar,
					newDepVar));
	}
	...
	public EList<Parameter> getParams() {
		if (params == null) {
			params = new EObjectContainmentEList<Parameter>(Parameter.class,
					this, ModelsPackage.SECONDARY_MODEL_FORMULA__PARAMS);
		}
		return params;
	}
	...
	public EList<Variable> getIndepVars() {
		if (indepVars == null) {
			indepVars = new EObjectContainmentEList<Variable>(Variable.class,
					this, ModelsPackage.SECONDARY_MODEL_FORMULA__INDEP_VARS);
		}
		return indepVars;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ModelsPackage.SECONDARY_MODEL_FORMULA__NAME:
			return getName();
		case ModelsPackage.SECONDARY_MODEL_FORMULA__FORMULA:
			return getFormula();
		case ModelsPackage.SECONDARY_MODEL_FORMULA__DEP_VAR:
			return getDepVar();
		case ModelsPackage.SECONDARY_MODEL_FORMULA__PARAMS:
