 ...
 * <ul>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.PrimaryModelFormulaImpl#getId
 * <em>Id</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.PrimaryModelFormulaImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.PrimaryModelFormulaImpl#getFormula
 * <em>Formula</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.PrimaryModelFormulaImpl#getDepVar
 * <em>Dep Var</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.PrimaryModelFormulaImpl#getParams
 * <em>Params</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.PrimaryModelFormulaImpl#getIndepVar
 * <em>Indep Var</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class PrimaryModelFormulaImpl extends EObjectImpl implements
		PrimaryModelFormula {
	/**
	...
	/**
	 * The cached value of the '{@link #getIndepVar() <em>Indep Var</em>}'
	 * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getIndepVar()
	 * @generated
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.PRIMARY_MODEL_FORMULA__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.PRIMARY_MODEL_FORMULA__NAME, oldName, name));
	}
	...
	public void setFormula(String newFormula) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.PRIMARY_MODEL_FORMULA__FORMULA, oldFormula,
					formula));
	}
	...
	public NotificationChain basicSetDepVar(Variable newDepVar,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ModelsPackage.PRIMARY_MODEL_FORMULA__DEP_VAR, oldDepVar,
					newDepVar);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDepVar(Variable newDepVar) {
		if (newDepVar != depVar) {
			...
			if (depVar != null)
				msgs = ((InternalEObject) depVar).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- ModelsPackage.PRIMARY_MODEL_FORMULA__DEP_VAR,
						null, msgs);
			if (newDepVar != null)
				msgs = ((InternalEObject) newDepVar).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- ModelsPackage.PRIMARY_MODEL_FORMULA__DEP_VAR,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.PRIMARY_MODEL_FORMULA__DEP_VAR, newDepVar,
					newDepVar));
	}
	...
	public EList<Parameter> getParams() {
		if (params == null) {
			params = new EObjectContainmentEList<Parameter>(Parameter.class,
					this, ModelsPackage.PRIMARY_MODEL_FORMULA__PARAMS);
		}
		return params;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIndepVar(Variable newIndepVar,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ModelsPackage.PRIMARY_MODEL_FORMULA__INDEP_VAR,
					oldIndepVar, newIndepVar);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
			...
			if (indepVar != null)
				msgs = ((InternalEObject) indepVar)
						.eInverseRemove(
								...
								null, msgs);
			if (newIndepVar != null)
				msgs = ((InternalEObject) newIndepVar)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- ModelsPackage.PRIMARY_MODEL_FORMULA__INDEP_VAR,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ModelsPackage.PRIMARY_MODEL_FORMULA__NAME:
			return getName();
		case ModelsPackage.PRIMARY_MODEL_FORMULA__FORMULA:
			return getFormula();
		case ModelsPackage.PRIMARY_MODEL_FORMULA__DEP_VAR:
			return getDepVar();
		case ModelsPackage.PRIMARY_MODEL_FORMULA__PARAMS:
