 ...
 * <em><b>String To Variable Range Map Entry</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.StringToVariableRangeMapEntryImpl#getTypedKey
 * <em>Key</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.StringToVariableRangeMapEntryImpl#getTypedValue
 * <em>Value</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class StringToVariableRangeMapEntryImpl extends EObjectImpl implements
		BasicEMap.Entry<String, VariableRange> {
	/**
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.STRING_TO_VARIABLE_RANGE_MAP_ENTRY__KEY,
					oldKey, key));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTypedValue(VariableRange newValue,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ModelsPackage.STRING_TO_VARIABLE_RANGE_MAP_ENTRY__VALUE,
					oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public EMap<String, VariableRange> getEMap() {
		...
		return container == null ? null
				: (EMap<String, VariableRange>) container
