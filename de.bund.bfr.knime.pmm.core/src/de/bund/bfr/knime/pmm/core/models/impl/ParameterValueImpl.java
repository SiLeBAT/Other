 ...
 * <ul>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.ParameterValueImpl#getValue
 * <em>Value</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.ParameterValueImpl#getError
 * <em>Error</em>}</li>
 * <li>{@link de.bund.bfr.knime.pmm.core.models.impl.ParameterValueImpl#getT
 * <em>T</em>}</li>
 * <li>{@link de.bund.bfr.knime.pmm.core.models.impl.ParameterValueImpl#getP
 * <em>P</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.ParameterValueImpl#getCorrelations
...
public class ParameterValueImpl extends EObjectImpl implements ParameterValue {
	...
	/**
	 * The cached value of the '{@link #getCorrelations() <em>Correlations</em>}
	...
	public void setValue(Double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.PARAMETER_VALUE__VALUE, oldValue, value));
	}
	...
	public void setError(Double newError) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.PARAMETER_VALUE__ERROR, oldError, error));
	}
	...
	public void setT(Double newT) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.PARAMETER_VALUE__T, oldT, t));
	}
	...
	public void setP(Double newP) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.PARAMETER_VALUE__P, oldP, p));
	}
	...
	public EMap<String, Double> getCorrelations() {
		if (correlations == null) {
			correlations = new EcoreEMap<String, Double>(
					ModelsPackage.Literals.STRING_TO_DOUBLE_MAP_ENTRY,
					StringToDoubleMapEntryImpl.class, this,
					ModelsPackage.PARAMETER_VALUE__CORRELATIONS);
		}
		return correlations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case ModelsPackage.PARAMETER_VALUE__CORRELATIONS:
			return ((InternalEList<?>) getCorrelations()).basicRemove(otherEnd,
					msgs);
		}
