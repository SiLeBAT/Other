 ...
 * <ul>
 * <li>{@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getId
 * <em>Id</em>}</li>
 * <li>{@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getSse
 * <em>Sse</em>}</li>
 * <li>{@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getMse
 * <em>Mse</em>}</li>
 * <li>{@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getRmse
 * <em>Rmse</em>}</li>
 * <li>{@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getR2
 * <em>R2</em>}</li>
 * <li>{@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getAic
 * <em>Aic</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getDegreesOfFreedom
 * <em>Degrees Of Freedom</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getVariableRanges
 * <em>Variable Ranges</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getParamValues
 * <em>Param Values</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getModelFormula
 * <em>Model Formula</em>}</li>
 * <li>{@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getData
 * <em>Data</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.TertiaryModelImpl#getAssignments
...
public class TertiaryModelImpl extends EObjectImpl implements TertiaryModel {
	 ...
	 * @ordered
	 */
	protected TertiaryModelFormula modelFormula;
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.TERTIARY_MODEL__ID, oldId, id));
	}
	...
	public void setSse(Double newSse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.TERTIARY_MODEL__SSE, oldSse, sse));
	}
	...
	public void setMse(Double newMse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.TERTIARY_MODEL__MSE, oldMse, mse));
	}
	...
	public void setRmse(Double newRmse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.TERTIARY_MODEL__RMSE, oldRmse, rmse));
	}
	...
	public void setR2(Double newR2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.TERTIARY_MODEL__R2, oldR2, r2));
	}
	...
	public void setAic(Double newAic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.TERTIARY_MODEL__AIC, oldAic, aic));
	}
	...
	public void setDegreesOfFreedom(Integer newDegreesOfFreedom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.TERTIARY_MODEL__DEGREES_OF_FREEDOM,
	...
	public EMap<String, VariableRange> getVariableRanges() {
		if (variableRanges == null) {
			variableRanges = new EcoreEMap<String, VariableRange>(
					...
					ModelsPackage.TERTIARY_MODEL__VARIABLE_RANGES);
		}
	...
	public EMap<String, ParameterValue> getParamValues() {
		if (paramValues == null) {
			paramValues = new EcoreEMap<String, ParameterValue>(
					...
					ModelsPackage.TERTIARY_MODEL__PARAM_VALUES);
		}
		return paramValues;
	}
	 ...
	 */
	@Override
	public TertiaryModelFormula getModelFormula() {
		if (modelFormula != null && modelFormula.eIsProxy()) {
			InternalEObject oldModelFormula = (InternalEObject) modelFormula;
			modelFormula = (TertiaryModelFormula) eResolveProxy(oldModelFormula);
			if (modelFormula != oldModelFormula) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModelsPackage.TERTIARY_MODEL__MODEL_FORMULA,
	 ...
	 * @generated
	 */
	public TertiaryModelFormula basicGetModelFormula() {
		return modelFormula;
	}
	 ...
	 */
	@Override
	public void setModelFormula(TertiaryModelFormula newModelFormula) {
		TertiaryModelFormula oldModelFormula = modelFormula;
	...
	public EList<TimeSeries> getData() {
		if (data == null) {
			data = new EObjectResolvingEList<TimeSeries>(TimeSeries.class,
					this, ModelsPackage.TERTIARY_MODEL__DATA);
		}
		return data;
	}
	...
	public EMap<String, String> getAssignments() {
		if (assignments == null) {
			assignments = new EcoreEMap<String, String>(
					...
					ModelsPackage.TERTIARY_MODEL__ASSIGNMENTS);
		}
		return assignments;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ModelsPackage.TERTIARY_MODEL__MODEL_FORMULA:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ModelsPackage.TERTIARY_MODEL__PARAM_VALUES:
			...
			return;
		case ModelsPackage.TERTIARY_MODEL__MODEL_FORMULA:
			setModelFormula((TertiaryModelFormula) newValue);
			return;
		case ModelsPackage.TERTIARY_MODEL__DATA:
			getData().clear();
	...
	public void eUnset(int featureID) {
		...
		case ModelsPackage.TERTIARY_MODEL__PARAM_VALUES:
			...
			return;
		case ModelsPackage.TERTIARY_MODEL__MODEL_FORMULA:
			setModelFormula((TertiaryModelFormula) null);
			return;
		case ModelsPackage.TERTIARY_MODEL__DATA:
			getData().clear();
			return;
