 ...
 * <ul>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.StringToStringMapEntryImpl#getTypedKey
 * <em>Key</em>}</li>
 * <li>
 * {@link de.bund.bfr.knime.pmm.core.models.impl.StringToStringMapEntryImpl#getTypedValue
 * <em>Value</em>}</li>
 * </ul>
 * </p>
 * 
...
public class StringToStringMapEntryImpl extends EObjectImpl implements
	...
	protected EClass eStaticClass() {
		return ModelsPackage.Literals.STRING_TO_STRING_MAP_ENTRY;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.STRING_TO_STRING_MAP_ENTRY__KEY, oldKey, key));
	}
	...
	public void setTypedValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelsPackage.STRING_TO_STRING_MAP_ENTRY__VALUE, oldValue,
					value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModelsPackage.STRING_TO_STRING_MAP_ENTRY__KEY:
			return getTypedKey();
		case ModelsPackage.STRING_TO_STRING_MAP_ENTRY__VALUE:
