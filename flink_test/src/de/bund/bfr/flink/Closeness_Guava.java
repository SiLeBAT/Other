...
public class Closeness_Guava {
	...
	public static void main(String[] args) throws Exception {
		...
		env.readCsvFile(edgesFile).types(Long.class, Long.class).reduceGroup(
				...
				.map(new MapFunction<Tuple2<Tuple2<SetMultimap<String, Long>, SetMultimap<Long, String>>, Long>, Tuple2<Long, Double>>() {

					@Override
					public Tuple2<Long, Double> map(
							Tuple2<Tuple2<SetMultimap<String, Long>, SetMultimap<Long, String>>, Long> graphWithNodeId)
							throws Exception {
						SetMultimap<String, Long> incidentNodes = graphWithNodeId.f0.f0;
						SetMultimap<Long, String> outgoingEdges = graphWithNodeId.f0.f1;
