 ...
 */
public class StratosphereNodePlugin extends Plugin {
    // The shared instance.
    private static StratosphereNodePlugin plugin;

    /**
     * The constructor.
     */
    public StratosphereNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static StratosphereNodePlugin getDefault() {
        return plugin;
    }
