 ...
 */
public class MyDBWriterNodePlugin extends Plugin {
    // The shared instance.
    private static MyDBWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public MyDBWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MyDBWriterNodePlugin getDefault() {
        return plugin;
    }
