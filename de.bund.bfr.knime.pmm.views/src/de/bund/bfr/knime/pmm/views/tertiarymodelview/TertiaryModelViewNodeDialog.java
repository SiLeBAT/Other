...
/**
 * <code>NodeDialog</code> for the "TertiaryModelView" Node.
 * 
 * 
 ...
 */
public class TertiaryModelViewNodeDialog extends DataAwareNodeDialogPane
		implements ChartSelectionPanel.SelectionListener,
		ChartConfigPanel.ConfigListener {

	private TertiaryModelViewReader reader;
	 ...
	 */
	protected TertiaryModelViewNodeDialog() {
	...
	protected void loadSettingsFrom(NodeSettingsRO settings, PortObject[] input)
		...
		set.load(settings);
		reader = new TertiaryModelViewReader((PmmPortObject) input[0]);
