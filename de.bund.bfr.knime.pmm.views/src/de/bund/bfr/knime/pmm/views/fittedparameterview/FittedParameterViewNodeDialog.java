...
public class FittedParameterViewNodeDialog extends DataAwareNodeDialogPane
	...
	private FittedParameterViewReader reader;
	private FittedParameterViewSettings set;
	...
	protected void loadSettingsFrom(NodeSettingsRO settings, PortObject[] input)
		...
		set = new FittedParameterViewSettings();
		set.load(settings);
		reader = new FittedParameterViewReader((PmmPortObject) input[0]);
	...
	private JComponent createMainComponent() {
		...
		selectionPanel = new ChartSelectionPanel(reader.getIds(), true,
				reader.getStringColumns(), null, reader.getConditions(),
				reader.getConditionMinValues(), reader.getConditionMaxValues(),
				reader.getConditionUnits(), null, null, null, null, null,
